...
if("search".equals(func)) {
    ...
    try {  
        ...
        String qry2 = getQuery(pgmid, "qryStList"); 
        String qry2Run = bindVAR(qry2,INVAR);
        OUTVAR.put("qry2Run",qry2Run); //for debug
        JSONArray st_list = selectSVC(conn, qry2Run);
        OUTVAR.put("st_list",st_list); 
...
if("save".equals(func)) {
    ...
    try {  
        ...
        if("Y".equals(getVal(INVAR,"delOnce"))) {
