...
/***************************************************************************************************/
    ...
    if("save".equals(func)) {
        ...
        try { 
            ...
            qry += "merge into his_pgm using dual on ( pgmid = {pgmid}) when matched then update set pgm_nm = {pgm_nm} , pgm_tp = {pgm_tp} , app_pgmid = {app_pgmid} , pgm_grp_nm =  {pgm_grp_nm} , shortcut = {shortcut} , sort_seq = {sort_seq} , remark = {remark} , ver = {ver} , pgm_stat = {pgm_stat} , upd_usid = {usid} , upd_dt = SYSDATE   WHEN NOT MATCHED THEN INSERT ( pgmid , pgm_nm , pgm_tp , app_pgmid , pgm_grp_nm ,  shortcut, sort_seq, remark, ver, pgm_stat, reg_usid, reg_dt, upd_usid, upd_dt ) VALUES ( {pgmid} , {pgm_nm} , {pgm_tp} , {app_pgmid} , {pgm_grp_nm} , {shortcut} , {sort_seq} , {remark} , {ver} , {pgm_stat} , {usid} , SYSDATE , {usid} , SYSDATE );";
