...
if("search".equals(func)) {
    ...
    try {  
        ...
        String qryC = getQuery(pgmid, "qrySearchChief"); 
        String qryRunC = bindVAR(qryC,INVAR);
        OUTVAR.put("qryRunC",qryRunC); //for debug
        JSONArray chief = selectSVC(conn, qryRunC);
        OUTVAR.put("chief",chief); 
...
if("saveChief".equals(func)) {
    ...
    try {  
        ...
        String qry = getQuery(pgmid, "qrySaveChief"); 
        String qryRun = bindVAR(qry,INVAR);
        OUTVAR.put("qryRun",qryRun); //for debug  
...
if("save".equals(func)) {
    ...
    try {  
        ...
        for(int i = 0; i < arrList.size(); i++) {
            ...
            row.put("dz_tp", getVal(INVAR,"dz_tp")); 
