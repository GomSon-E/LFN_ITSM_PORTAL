...
if("refresh".equals(func)) {
    ...
    try {  
        ...
        String qrysharedocs = getQuery(pgmid, "qrysharedocs"); 
        qrysharedocs = bindVAR(qrysharedocs,INVAR);
        OUTVAR.put("qrysharedocs",qrysharedocs); //for debug
        JSONArray sharedocs = selectSVC(conn, qrysharedocs);
        OUTVAR.put("sharedocs",sharedocs);
