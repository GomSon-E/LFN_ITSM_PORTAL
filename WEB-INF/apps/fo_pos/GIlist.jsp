...
if("acceptBox".equals(func)) {
    ...
    try {  
        ...
        String type = getVal(INVAR, "lg_tp");
        
        //박스 인수 확인
        String qry1 = getQuery(pgmid, "acceptBox");
        qry1 = bindVAR(qry1, INVAR);
        JSONObject rst = executeSVC(conn, qry1);
        ...
        //박스 인수 정상 처리 후, LG_TP가 GR인 경우, TS_DIRECT_GR_GOODS 업데이트
        if(!bCheck && type.equals("GR")) {
            String qry2 = getQuery(pgmid, "acceptDirect");
