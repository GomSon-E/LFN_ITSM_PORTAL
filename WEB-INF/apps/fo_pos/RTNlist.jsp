...
if("print".equals(func)) {
    ...
    try {  
        ...
        */
        ...
        String lg_tp = getVal(INVAR, "lg_tp");
        String qryP = null;
        if(lg_tp.equals("RED")) { //불량반품일때 박스별 브랜드로 나오게
            qryP = getQuery(pgmid, "qryprint"); 
        } else { //나머지유형은 브랜드별로 나오게
            qryP = getQuery(pgmid, "qryprint2"); 
        }
