...
if("sendMsg2".equals(func)) {
    ...
    try {  
        ...
        for(int k=0; k<usidlist.size(); k++){
            ...
            //전송한 후 
            //if(isNull(sUrl)) 
            sUrl = "https://www.worksapis.com/v1.0/bots/4100179/users/"+usid+"/messages";
    	    //if(isNull(enc)) 
    	    enc = "UTF-8"; 
            URL url = new URL(sUrl);
    	    HttpURLConnection huc = (HttpURLConnection)url.openConnection();
...
if("sendBotChat".equals(func)) {
    ...
    try {  
        ...
        sUrl = "https://www.worksapis.com/v1.0/bots/4100179/channels/"+channelId+"/messages";
        //OUTVAR.put("url",sUrl);
   	    enc = "UTF-8"; 
        URL url = new URL(sUrl);
  	    HttpURLConnection huc = (HttpURLConnection)url.openConnection();
