...
if("search".equals(func)) {
    ...
    try {  
        ...
        String qrySSSN = getQuery(pgmid, "qrysssnInfo"); 
        INVAR.put("comcd",ORGCD);
        qrySSSN = bindVAR(qrySSSN,INVAR); 
        JSONArray sssnInfo = selectSVC(conn, qrySSSN);
        OUTVAR.put("sssnInfo",sssnInfo);  
