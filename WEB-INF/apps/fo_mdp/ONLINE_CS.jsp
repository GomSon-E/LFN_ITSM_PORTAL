...
//OUTVAR.put("jsonObj", org.json.XML.toJSONObject(xmlStr)); 
    ...
    String xmlStr2 = makeXML(INVAR,"SABANG_CS_LIST",0); //JSONObject jo, String rootTag, Boolean bRoot)//org.json.XML.toString(INVAR);
    ...
    try {
	    ...
	    if(isNull(sUrl)) sUrl = "https://sbadmin01.sabangnet.co.kr/RTL_API/xml_cs_info.html?xml_url=" + LFurl + fileid + ".xml";
...
//OUTVAR.put("jsonObj", org.json.XML.toJSONObject(xmlStr)); 
    ...
    String xmlStr2 = makeXML(INVAR,"SABANG_CS_ANS_REGI",0); //JSONObject jo, String rootTag, Boolean bRoot)//org.json.XML.toString(INVAR);
    OUTVAR.put("xmlStr2",xmlStr2); 
    ...
    try {
	    ...
	    String LFurl = "https://fo.lfnetworks.co.kr/pds/API/" + today + "/";
	    if(isNull(sUrl)) sUrl = "https://sbadmin01.sabangnet.co.kr/RTL_API/xml_cs_ans.html?xml_url=" + LFurl + fileid + ".xml";
	    if(isNull(enc)) enc = "UTF-8";
	    //if(isNull(enc)) 
        URL url = new URL(sUrl);
        OUTVAR.put("sUrl",sUrl);
