...
public String makeXML(JSONObject jo, String rootTag, int Depth) throws Exception {
    ...
    */ 
    ...
    header += "<SEND_DATA><![CDATA[" + today + "]]></SEND_DATA>"+CR;
...
if("search2".equals(func)) {
    ...
    try {  
        ...
        String qry3 = getQuery(pgmid, "qrysearch4"); 
...
//OUTVAR.put("jsonObj", org.json.XML.toJSONObject(xmlStr)); 
    ...
    String xmlStr2 = makeXML(INVAR,"SABANG_GOODS_REGI",0); //JSONObject jo, String rootTag, Boolean bRoot)//org.json.XML.toString(INVAR);
    ...
    try {
	    ...
	    if(isNull(sUrl)) sUrl = "http://sbadmin01.sabangnet.co.kr/RTL_API/xml_goods_info.html?xml_url=" + LFurl + fileid + ".xml";
