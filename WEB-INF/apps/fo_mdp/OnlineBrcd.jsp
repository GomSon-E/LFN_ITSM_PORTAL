...
if("search".equals(func)) {
    ...
    try {   
        ...
        String qry3 = getQuery(pgmid,"retrieveBrcd"); //T_PGM_SRC.content 
        qry3 = bindVAR(qry3,INVAR); //OUTVAR.put("qry",qry);
        JSONArray list2 = selectSVC(conn,qry3);   
