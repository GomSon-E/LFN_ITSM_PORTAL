...
//OUTVAR.put("jsonObj", org.json.XML.toJSONObject(xmlStr)); 
    ...
    String xmlStr2 = makeXML(INVAR,"SABANG_ORDER_LIST",0); //JSONObject jo, String rootTag, Boolean bRoot)//org.json.XML.toString(INVAR);
    ...
    try {
	    ...
	    if(isNull(sUrl)) sUrl = "https://sbadmin01.sabangnet.co.kr/RTL_API/xml_order_info.html?xml_url=" + LFurl + fileid + ".xml";
...
//OUTVAR.put("jsonObj", org.json.XML.toJSONObject(xmlStr)); 
    ...
    try {
	    ...
	    String LFurl = "https://fo.lfnetworks.co.kr/pds/API/" + today + "/";
	    if(isNull(sUrl)) sUrl = "https://sbadmin01.sabangnet.co.kr/RTL_API/xml_clm_info.html?xml_url=" + LFurl + fileid + ".xml";
	    if(isNull(enc)) enc = "UTF-8";
	    //if(isNull(enc)) 
        URL url = new URL(sUrl);
        OUTVAR.put("sUrl",sUrl);
